...
survey_responses_today %>% 
  ...
  mutate(what_is_the_highest_level_of_education_you_have_completed = factor(what_is_the_highest_level_of_education_you_have_completed, 
                                                                            levels = c("High school", "Associate's degree", "Bachelor's degree", "Master's degree", "Doctoral degree", "Other"))) %>% 
...
survey_responses_today %>% 
  ...
  labs(title = "Interest in Learning R by Education Level",
       x = NULL,
       y = NULL) 
```
